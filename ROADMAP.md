...
**2026-09-17 — ბაზა განულდა:** ცოცხალი ბაზიდან წაიშალა ყველა შეკვეთა (291), მომხმარებელი (82),
შეფასება, მარაგის ჟურნალი, ვიზიტები, ანალიტიკის მრიცხველები და ცვლილებების ჟურნალი. დარჩა
კატალოგი, მარაგის რაოდენობები, ზონები, კუპონები (გამოყენება 0-ზე), თანამშრომლები, პარამეტრები,
გადახდის მეთოდები და გვერდები. წაშლის წინ ბექაპია: `backups/bazari-2026-09-17T00-10.json`
(`npm run db:restore`). იგივე გასუფთავება მომავალშიც: `npm run db:reset-live -- --yes`.
სატესტო მომხმარებელი (`user@bazari.ge`) აღარ არსებობს — ახალი ანგარიში საიტიდანვე იქმნება.
